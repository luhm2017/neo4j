...
object CommonConstant extends Serializable {
  ...
  //申请时间
  val APPLY_DATE = "applyDate"
  //产品名称
  val PRODUCT_NAME = "productName"
  //申请状态
  val APPLY_STATE = "applyState"
  //最终申请状态
  val APPLY_LAST_STATE = "applyLastState"
  //失败原因
  val FAIL_REASON = "failReason"
  //当前逾期天数
  val CURRENT_DUE_DAY = "currentDueDay"
  //历史最大逾期天数
  val HISTORY_DUE_DAY = "historyDueDay"
  //是否Q标拒绝  other_refuse 或者 q_refuse
